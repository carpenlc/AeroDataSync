 ...
 * UPG_SYNCHRONIZATION_METRICS table used to keep track of metrics 
 * associated with individual runs of the UPG synchronization process.
 */
@Stateless
@LocalBean
public class JDBCUPGMetricsService 
            ...
            if (metrics != null) {
                ...
                try { 
                    ...
                    LOGGER.error("An unexpected SQLException was raised while "
                            ...
                            + "UPG_SYNCHRONIZATION_METRICS object.  "
                            + "Error message [ "
                            + se.getMessage() 
                            + " ].");
                }
